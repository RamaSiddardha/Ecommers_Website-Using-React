...
const RegistrationForm = () => {
  ...
  const forgetPasswordHandler = () => {
    ...
    fetch(
      "https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyCcj91NYwU8MP3k-ZS7p0Topl5nnhJhXKM",
      {
        method: "POST",
        body: JSON.stringify({
  ...
  const submitHandler = (e) => {
    ...
    if (isLogin) {
      Url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCcj91NYwU8MP3k-ZS7p0Topl5nnhJhXKM";
    } else {
    ...
    if (enteredPassword !== enteredConformPassword) {
      ...
      Url =
        "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyCcj91NYwU8MP3k-ZS7p0Topl5nnhJhXKM";
    }
